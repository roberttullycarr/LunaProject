    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=40, verbose_name='location')),
                ...
                ('things_i_love', models.CharField(blank=True, max_length=200, verbose_name='things_i_love')),
                ('description', models.CharField(blank=True, max_length=400, verbose_name='description')),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='user_media')),
                ('friends_with', models.ManyToManyField(blank=True, related_name='friends_of', to=settings.AUTH_USER_MODEL)),
